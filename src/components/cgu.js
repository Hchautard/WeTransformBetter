    ...
    return (
        <div class="container">
            ...
            <div class="article">
                ...
                <p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique de l’utilisation du site WeTransformBetter et de ses services.</p>
            ...
            <div class="article">
                ...
                <p>Le site WeTransformBetter est édité par la société WeTransformCorporation (SAS, SARL, etc.) au capital de 10 000€, dont le siège social est situé au Avignon Centre.</p>
                <p>La société est représentée par Julien JAMME.</p>

                <h3>Pour les personnes physiques :</h3>
                <p>Le site WeTransformBetter est édité par Hugo CHAUTARD, domicilié au Saint-Rémy.</p>
            </div>

            <div class="article">
                <h2>ARTICLE 3 : Accès aux services</h2>
                <p>L’Utilisateur du site WeTransformBetter a accès aux services suivants :</p>
                <ul>
                    <li>Transformation d’image</li>
                    <li>Téléchargement d’image</li>
                    <li>Transformation en noir et blanc</li>
                    <li>Changer le sens de l’image</li>
                </ul>
            ...
            <div class="article">
                ...
                <p>L’Utilisateur assume l’entière responsabilité de l’utilisation qu’il fait des informations et contenus présents sur le site WeTransformBetter.</p>
            ...
            <div class="article">
                ...
                <p>Le site WeTransformBetter s'engage à mettre en œuvre tous les moyens nécessaires pour garantir la sécurité et la confidentialité des données. Toutefois, il n’apporte pas une garantie de sécurité totale.</p>
            ...
            <div class="article">
                ...
                <p>Les contenus du site WeTransformBetter (logos, textes, éléments graphiques, vidéos, etc.) sont protégés par le droit d’auteur, en vertu du Code de la propriété intellectuelle.</p>
            ...
            <div class="article">
                ...
                <p>L’adresse électronique (e-mail) de l’utilisateur pourra notamment être utilisée par le site WeTransformBetter pour la communication d’informations diverses et la gestion du compte.</p>
                <p>WeTransformBetter garantit le respect de la vie privée de l’utilisateur, conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés.</p>
                ...
                <ul>
                    ...
                    <li>Par mail à <a href="mailto:WeTransformBetter@gmail.com">WeTransformBetter@gmail.com</a> ;</li>
                    <li>Par voie postale au Avignon Centre.</li>
                </ul>
            </div>

            <div class="article">
                <h2>ARTICLE 8 : Liens hypertextes</h2>
                <p>Les domaines vers lesquels mènent les liens hypertextes présents sur le site n’engagent pas la responsabilité de l’Éditeur de WeTransformBetter, qui n’a pas de contrôle sur ces liens.</p>
                <p>Il est possible pour un tiers de créer un lien vers une page du site WeTransformBetter sans autorisation expresse de l’éditeur.</p>
            </div>

            <div class="article">
                <h2>ARTICLE 9 : Évolution des conditions générales d’utilisation</h2>
                <p>Le site WeTransformBetter se réserve le droit de modifier les clauses de ces conditions générales d’utilisation à tout moment et sans justification.</p>
            </div>
